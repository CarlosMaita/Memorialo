...
const laravelPrefixes = ['/health', '/auth', '/users', '/providers', '/services', '/contracts', '/bookings', '/events', '/billing', '/admin', '/marketplace', '/upload-image', '/reviews', '/notifications', '/favorites', '/chat', '/banners'];
