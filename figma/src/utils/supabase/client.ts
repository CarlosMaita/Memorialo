...
const laravelPrefixes = ['/health', '/auth', '/users', '/providers', '/services', '/collections', '/contracts', '/bookings', '/events', '/billing', '/admin', '/marketplace', '/upload-image', '/reviews', '/notifications', '/favorites', '/chat', '/banners'];
