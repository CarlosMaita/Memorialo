...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('marketplace_settings', function (Blueprint $table) {
            $table->string('main_content_accent')->nullable()->after('relevant_service_ids');
            $table->string('main_content_title')->nullable()->after('main_content_accent');
            ...
            $table->string('main_content_primary_button_link')->nullable()->after('main_content_primary_button_text');
            $table->string('main_content_secondary_button_text', 80)->nullable()->after('main_content_primary_button_link');
            $table->string('main_content_secondary_button_link')->nullable()->after('main_content_secondary_button_text');
        });
    }
